...
export async function getLoteriaFederal(): Promise<LoteriaFederal[]> {
  ...
  const { data, error } = await supabase
    .from("loteria_federal")
    .select("*")
    .eq("usuario_id", user.id)
    .order("data", { ascending: false });

  if (error) {
    throw new Error("Não foi possível carregar os resultados da Loteria Federal.");
  }
...
export async function createLoteriaFederal(payload: LoteriaFederalInsert): Promise<LoteriaFederal> {
  ...
  if (error || !data) {
    throw new Error("Não foi possível salvar o resultado da Loteria Federal.");
  }
...
export async function updateLoteriaFederal(id: string, payload: LoteriaFederalUpdate): Promise<LoteriaFederal> {
  ...
  if (error || !data) {
    throw new Error("Não foi possível atualizar o resultado da Loteria Federal.");
  }
...
export async function deleteLoteriaFederal(id: string): Promise<void> {
  ...
  if (error) {
    throw new Error("Não foi possível excluir o resultado da Loteria Federal.");
  }
}
...
export async function getLances(): Promise<Lance[]> {
  ...
  if (error) {
    throw new Error("Não foi possível carregar os lances.");
  }
...
export async function getLancesByAssembleia(assembleiaId: string): Promise<Lance[]> {
  ...
  if (error) {
    throw new Error("Não foi possível carregar os lances da assembleia.");
  }
...
export async function createLance(payload: LanceInsert): Promise<Lance> {
  ...
  if (error || !data) {
    throw new Error("Não foi possível salvar o lance.");
  }
...
export async function updateLance(id: string, payload: LanceUpdate): Promise<Lance> {
  ...
  if (error || !data) {
    throw new Error("Não foi possível atualizar o lance.");
  }
...
export async function deleteLance(id: string): Promise<void> {
  ...
  if (error) {
    throw new Error("Não foi possível excluir o lance.");
  }
}