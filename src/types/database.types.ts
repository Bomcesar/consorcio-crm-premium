    ...
    Tables: {
      ...
      negociacoes: {
        Row: {
          ...
          prazo: number;
          taxa: number;
          valor_lance_entrada: number;
          tipo_carta_credito: string;
          parcela_cheia: number;
          parcela_reduzida: number;
          administradora: string;
          tipo_bem: string;
          comissao_estimada_em_porcentagem: number;
          documentos_dados_cadastrais_checklist: unknown;
          created_at: string;
          updated_at: string;
        };
        Insert: {
