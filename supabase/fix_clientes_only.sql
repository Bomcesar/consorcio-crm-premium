-- Script corrigido: apenas tabelas que existem no banco

BEGIN;

-- CLIENTES: adiciona usuario_id se faltar
DO $$
BEGIN
  IF NOT EXISTS (
...
-- Remove policies antigas de clientes
...
-- Recria policies básicas de clientes
